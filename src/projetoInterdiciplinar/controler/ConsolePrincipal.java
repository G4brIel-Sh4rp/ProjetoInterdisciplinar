...
public class ConsolePrincipal {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        Date d = formatar.parse("12/2020");
        System.out.println(formatar1.format(d));
        
//        String marcas[] = estCel.getMarcas();
//        for (int i = 0; i < marcas.length; i++) {
//            System.out.println(marcas[i]);
//        }
//        System.out.println("FIM - Quantidade de marcas: "+marcas.length);
